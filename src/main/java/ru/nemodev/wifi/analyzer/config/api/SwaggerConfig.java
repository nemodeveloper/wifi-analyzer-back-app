...
public class SwaggerConfig implements WebMvcConfigurer {
    private static final String BASE_ENDPOINT_PACKAGE = "ru.nemodev.wifi.analyzer.api.endpoint";

    @Bean
    public Docket api_v1() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("wifi-analyzer-api-1.0")
                .select()
    ...
    private ApiInfo apiInfo_v1() {
        return new ApiInfoBuilder()
                .title("Wifi analyzer Rest API")
                .description("Service for analyze WIFI")
                .version("1.0")
